...
<section class="formations" id="formations">
    <div class="container">
        ...
        <!-- Bloc Formation Sur Mesure -->
        <div class="custom-formation-cta" style="margin-top: 60px; text-align: center;">
            <div class="custom-formation-card" style="background-color: var(--secondary); border-radius: 20px; padding: 50px 40px; box-shadow: 0 15px 40px rgba(0,0,0,0.3); max-width: 800px; margin: 0 auto;">
                <h3 style="font-size: 2.5rem; font-weight: 800; color: var(--primary); margin-bottom: 20px;">Créez votre formation sur mesure</h3>
                <p style="font-size: 1.3rem; color: var(--dark); margin-bottom: 30px; line-height: 1.6;">
                    Vous avez des besoins spécifiques ? Nous concevons des formations personnalisées adaptées à vos enjeux et à votre contexte professionnel.
                </p>
                <a href="#contact" class="btn" style="background-color: var(--primary); color: var(--light); font-size: 1.3rem; padding: 18px 50px;">Demandez des renseignements</a>
            </div>
        </div>
    </div>
</section>
